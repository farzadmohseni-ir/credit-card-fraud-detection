...
|--------|----------------------|--------------------------|---------------------------------------------------------------------------------------------|--------------------------------------|-----------------------------------------------------|
| 1      | Random Undersampling | Undersampling            | ساده و سریع، کاهش حجم داده <br> ➤ با حذف تصادفی از کلاس غالب، کلاس‌ها را برابر می‌کند. | احتمال حذف اطلاعات مفید            | ❌ خیلی ضعیف برای دیتاست بزرگ و نامتوازن           |
| 2      | Random Oversampling  | Oversampling             | حفظ داده‌ها، اجرای آسان <br> ➤ با تکرار تصادفی نمونه‌های کلاس اقلیت، تعادل ایجاد می‌کند. | احتمال بیش‌برازش                   | ⚠️ فقط برای تست‌های اولیه یا مدل‌های ساده پیشنهاد می‌شود |
| 3      | SMOTE                | Oversampling             | تولید داده‌های متنوع، کاهش Overfitting <br> ➤ داده‌های مصنوعی بین نزدیک‌ترین همسایه‌ها تولید می‌کند. | ممکن است داده مصنوعی نامعتبر تولید کند | ✅ مناسب، مخصوصاً برای شروع مدل‌سازی و مقایسه     |
| 4      | Borderline-SMOTE     | Oversampling             | تمرکز بر نقاط بحرانی، افزایش دقت <br> ➤ فقط اطراف مرز کلاس‌ها نمونه‌سازی می‌کند.        | حساس به نویز                        | ✅ مناسب، به‌ویژه برای مدل‌های دقیق‌تر              |
| 5      | ADASYN               | Oversampling             | تطبیق‌پذیر، تنوع بالا <br> ➤ در نواحی سخت‌تر، داده بیشتری تولید می‌کند.                   | ممکن است داده غیرواقعی تولید شود   | ✅ مناسب برای مدل‌های پیچیده‌تر                     |
| 6      | SMOTE-ENN            | Hybrid                   | حذف نویز، داده تمیزتر <br> ➤ پس از SMOTE، نمونه‌های نویزی را با ENN حذف می‌کند.          | پیچیده‌تر و زمان‌بر                | ✅ بسیار مناسب، مخصوصاً اگر دقت مهم باشد            |
| 7      | SMOTE-Tomek          | Hybrid                   | حذف همپوشانی کلاس‌ها <br> ➤ SMOTE + حذف نمونه‌های متداخل با Tomek Links                | پردازش بیشتر نیاز دارد             | ✅ مناسب برای حذف داده‌های مبهم و مرزی              |
| 8      | KMeans-SMOTE         | Oversampling هوشمند     | متنوع، کاهش Overfitting <br> ➤ با خوشه‌بندی قبل از SMOTE، داده متعادل و متنوع‌تری تولید می‌کند. | نیاز به تنظیم دقیق K              | ✅✅ بسیار مناسب برای دیتاست بزرگ و واقعی تو        |
