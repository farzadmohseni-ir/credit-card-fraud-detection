...
|-------------------------------|-------------------------------------|-------------------------------------------|----------------------------------------------|
| 🌍 منبع                        | ULB (Université Libre de Bruxelles) | European cardholders           | IEEE-CIS / Vesta Corporation                 |
| 📦 تعداد رکورد                | 284,807                             | 550,000                                    | 590,540                                      |
| 🔢 تعداد ویژگی                 | 31                                  | 31                                         | 431 (400 عددی + 31 دسته‌ای)                 |
...
<h2 dir="rtl" align="right">🧪 شکاف پژوهشی و انتخاب ترکیب پیشنهادی پایان‌نامه</h2>

<h3 dir="rtl" align="right">🌿 KMeans-SMOTE + CatBoost + Feature Processing</h3>

<p dir="rtl" align="right">
با بررسی دقیق ادبیات موضوعی و جستجو در پایگاه Google Scholar، مشخص شد که علی‌رغم کاربرد گسترده الگوریتم‌های یادگیری ماشین در حوزه کشف تقلب در کارت‌های اعتباری، <strong><code>KMeans-SMOTE + CatBoost + Feature Processing</code></strong> تاکنون به‌طور متمرکز و ساختاریافته مورد بررسی قرار نگرفته است.
</p>

<ul dir="rtl" align="right">
  <li>📌 <strong><code>KMeans-SMOTE</code></strong> تعادل بهتری بین کلاس‌ها با تولید داده‌های synthetic برقرار می‌کند، از طریق ترکیب خوشه‌بندی، جلوی overfitting رایج در SMOTE کلاسیک را می‌گیرد.</li>
  <li>📌 <strong><code>CatBoost</code></strong> طراحی‌شده برای داده‌های طبقه‌ای (Categorical) با دقت بالا در مدل‌سازی رفتارهای پیچیده و غیرخطی.</li>
  <li>📌 <strong><code>Feature Processing</code></strong> نقش اساسی در کشف الگوهای پنهان، افزایش دقت مدل، و انتخاب ویژگی‌های زمانی و تعاملی دارد.</li>
</ul>

---

<h3 dir="rtl" align="right">✨ چرا این انتخاب درخشان است؟</h3>
...
<ul dir="rtl" align="right">
  ...
  <li>✅ <strong>اجرایی، مستند و قابل دفاع:</strong> هر سه مؤلفه پیاده‌سازی‌شده در پایتون و کتابخانه‌های معروف هستند.</li>
  <li>✅ <strong>توانمندی علمی دانشجو:</strong> این انتخاب حاصل درک عمیق از مشکلات داده‌های واقعی و چالش‌های فنی پژوهشی است.</li>
  <li>✅ <strong>افزایش دقت و کاهش خطا:</strong> با یادگیری الگوهـای پیچیده و حذف نویزها، پیش‌بینی‌ها بسیار دقیق‌تر خواهند شد.</li>
  <li>🎯 <strong>این ترکیب، تلفیقی است از تحلیل هوشمند، پژوهشگر و شکاف موجود در پیشینه پژوهشی</strong> که آن را به گزینه‌ای ممتاز، درخشان و شایسته‌ی دفاع تبدیل می‌کند.</li>
</ul>


---

### 🎓✨ **دلیل انتخاب عنوان کلی و منعطف برای پایان‌نامه**

در فرآیند تدوین پایان‌نامه، انتخاب عنوانی با ساختار **کلی اما هدفمند**، یک تصمیم **هوشمندانه و آگاهانه** به شمار می‌رود.  
این رویکرد به پژوهشگر اجازه می‌دهد که در طول مسیر تحقیق، بر اساس:

- چالش‌های احتمالی  
- تغییر در دسترسی به داده‌ها  
- نتایج تجربی  
- یا راهنمایی‌های استاد راهنما  

بتواند مسیر پژوهش خود را با **انعطاف بیشتری** تنظیم نماید.

📌 **به‌جای محدود کردن موضوع** به یک الگوریتم یا تکنیک خاص، استفاده از عباراتی مثل:

- `الگوریتم‌های یادگیری ماشین`  
- `مدل‌های انسمبل`  

در عنوان پایان‌نامه، امکان **مقایسه چندین روش**، **نوآوری در ترکیب‌سازی** و **توسعه رویکردهای نوین** را فراهم می‌سازد.

---

### ✅ **عناوین پیشنهادی کلی و علمی برای پایان‌نامه**
...
- **English:**  
Credit Card Fraud Detection (CCFD) Using Data Balancing Techniques and Machine Learning Algorithms
...
### 🌟 **نتیجه‌گیری هوشمندانه:**

<div dir="rtl" align="right">

این عناوین، ضمن آنکه **علمی، معتبر و قابل دفاع** هستند، به شما اجازه می‌دهند که:

- با تحلیل شخصی  
- و خلاقیت در پژوهش  

ترکیب‌های **نوآورانه و قابل دفاعی** مثل:  

👉 <code>KMeans-SMOTE + CatBoost + Feature Processing</code>  

را طراحی، پیاده‌سازی و ارزیابی کنید — **بدون آن‌که در مسیر پژوهش با محدودیت‌های ساختاری روبه‌رو شوید.**
