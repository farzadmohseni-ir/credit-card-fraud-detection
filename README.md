...
| 🔢 ردیف | 🧠 دسته روش              | 🎓📘 عنوان پیشنهادی پایان‌نامه (فارسی / English)                                                               |
|--------|---------------------------|------------------------------------------------------------------------------------------------------------------|
| 1️⃣     | یادگیری ماشین             | 🎓 فارسی: کشف تقلب در کارت‌های اعتباری با استفاده از تکنیک‌های متعادل‌سازی داده و الگوریتم‌های یادگیری ماشین  
📘 English: *Credit Card Fraud Detection (CCFD) Using Data Balancing Techniques and Classical Machine Learning Algorithms* |
| 2️⃣     | یادگیری انسمبل            | 🎓 فارسی: کشف تقلب در کارت‌های اعتباری با استفاده از مدل‌های انسمبل و تکنیک‌های متعادل‌سازی داده  
📘 English: *Credit Card Fraud Detection (CCFD) Using Ensemble Models and Data Balancing Techniques* |
| 3️⃣     | یادگیری عمیق             | 🎓 فارسی: کشف تقلب در کارت‌های اعتباری با استفاده از الگوریتم‌های یادگیری عمیق و رویکردهای مقابله با عدم‌توازن داده  
📘 English: *Credit Card Fraud Detection (CCFD) Using Deep Learning Algorithms and Imbalanced Data Handling Approaches* |
| 4️⃣     | یادگیری ترکیبی           | 🎓 فارسی: کشف تقلب در کارت‌های اعتباری با استفاده از مدل‌های ترکیبی و تکنیک‌های متعادل‌سازی داده  
📘 English: *Credit Card Fraud Detection (CCFD) Using Hybrid Models and Data Balancing Techniques* |
| 5️⃣     | مدل‌های گرافی             | 🎓 فارسی: کشف تقلب در کارت‌های اعتباری با استفاده از مدل‌های مبتنی بر گراف و روش‌های مقابله با عدم‌توازن داده  
📘 English: *Credit Card Fraud Detection (CCFD) Using Graph-Based Models and Imbalanced Data Handling Techniques* |
| 6️⃣     | کشف ناهنجاری             | 🎓 فارسی: کشف تقلب در کارت‌های اعتباری با استفاده از روش‌های کشف ناهنجاری و تکنیک‌های متعادل‌سازی داده  
📘 English: *Credit Card Fraud Detection (CCFD) Using Anomaly Detection Methods and Data Balancing Techniques* |
| 7️⃣     | یادگیری نیمه‌نظارتی       | 🎓 فارسی: کشف تقلب در کارت‌های اعتباری با استفاده از یادگیری نیمه‌نظارتی و روش‌های مدیریت داده‌های نامتوازن  
📘 English: *Credit Card Fraud Detection (CCFD) Using Semi-Supervised Learning and Imbalanced Data Handling Techniques* |
| 8️⃣     | یادگیری تقویتی            | 🎓 فارسی: کشف تقلب در کارت‌های اعتباری با استفاده از یادگیری تقویتی و تکنیک‌های مقابله با داده‌های نامتوازن  
📘 English: *Credit Card Fraud Detection (CCFD) Using Reinforcement Learning and Imbalanced Data Handling Approaches* |
| 9️⃣     | یادگیری بدون نظارت        | 🎓 فارسی: کشف تقلب در کارت‌های اعتباری با استفاده از الگوریتم‌های یادگیری بدون نظارت و تحلیل داده‌های نامتوازن  
📘 English: *Credit Card Fraud Detection (CCFD) Using Unsupervised Learning Algorithms and Imbalanced Data Analysis* |
